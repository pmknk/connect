...
export const ProjectsActivityFilter = ({ value, onFilterChange }: ProjectsActivityFilterProps) => {
        ...
        <Stack direction="row" spacing={2}>
            ...
            >
                {filterOptions.map((option) => (
                    <MenuItem
                        key={option.value}
                        onClick={() => handleFilterChange(option.value as ProjectsActivityFilterValue)}
                        sx={{
                            minWidth: '100px',
                        }}
