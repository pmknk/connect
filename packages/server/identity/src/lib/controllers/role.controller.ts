...
import { GetRolesResponseDto, toGetRolesResponseDto } from '../dtos/get-roles.dto';
...
export class RoleController {
     ...
     */
    async getRoles(_request: FastifyRequest, reply: FastifyReply): Promise<GetRolesResponseDto> {
        return reply
            .status(200)
